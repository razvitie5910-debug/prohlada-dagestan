...
<html lang="ru">
  <head>
    ...
    <style>${css.replaceAll('url("/prohlada-cottage.png")', `url("${photoData}")`)}</style>
  </head>
  <body>
    <main>
      ...
      <section class="hero" id="top">
        ...
        <div class="hero-media">
          <img src="${photoData}" alt="Коттедж гостевого дома Прохлада у бассейна с водопадом">
